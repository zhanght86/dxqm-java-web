...
public class ProjectGanttController {
    ...
    public ActionResult<ListVO<ProjectGanttListVO>> list(Page page) {
        ...
        for(ProjectGanttListVO vo:list){
            List<ProjectGanttManagerModel> list1=new ArrayList<>();
    ...
    public ActionResult<ListVO<ProjectGanttTaskTreeVO>> taskTreeView(@PathVariable("projectId") String projectId) {
    ...
    public ActionResult<ProjectGanttInfoVO> info(@PathVariable("id") String id) throws DataException {
        ...
        ProjectGanttInfoVO vo = JsonUtilEx.getJsonToBeanEx(entity, ProjectGanttInfoVO.class);
        return ActionResult.success(vo);
    }
    /**
     * 信息
    ...
    public ActionResult<ProjectGanttTaskInfoVO> taskInfo(@PathVariable("id") String id) throws DataException {
        ProjectGanttEntity entity = projectGanttService.getInfo(id);
        ProjectGanttTaskInfoVO vo = JsonUtilEx.getJsonToBeanEx(entity, ProjectGanttTaskInfoVO.class);
        return ActionResult.success(vo);
    }
