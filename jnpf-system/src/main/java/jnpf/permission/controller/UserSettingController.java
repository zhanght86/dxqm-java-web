...
public class UserSettingController {
    ...
    public ActionResult<UserBaseInfoVO> get() {
        ...
        if (userEntity != null) {
            ...
            vo.setCompany(getCompany(userAllVO.getOrganize()));
            UserEntity menager = userService.getInfo(userAllVO.getManagerId());
    ...
    public ActionResult updateInfo(@RequestBody UserInfoForm userInfoForm) {
        ...
        userEntity.setBirthday(StringUtil.isEmpty(userInfoForm.getBirthday()) ? null : DateUtil.stringToDate(userInfoForm.getBirthday()));
     ...
     * @return
     */
    private String getCompany(String fullName) {
        //上级就是公司
        OrganizeEntity entity = organizeService.getInfoByFullName(fullName);
        if (entity == null) {
            return null;
        }
        ...
        //上级不是公司
        return getCompany(organizeService.getInfo(entity.getParentId()).getFullName());
    }
