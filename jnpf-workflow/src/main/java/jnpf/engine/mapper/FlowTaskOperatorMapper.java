...
public interface FlowTaskOperatorMapper extends BaseMapper<FlowTaskOperatorEntity> {
     ...
     * @param userId     用户id
     */
    void updateDelegateUser(@Param("taskNodeId") String taskNodeId, @Param("userId") String userId, @Param("completion") String completion);
     ...
     * @param nodeCode 节点id
     */
    void updateReject(@Param("taskId") String taskId, @Param("nodeCode") String nodeCode);
}
