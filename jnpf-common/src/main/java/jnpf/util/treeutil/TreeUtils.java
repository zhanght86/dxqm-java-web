...
public class TreeUtils {
     ...
     *
     * @param tList
     * @return java.jnpf.util.List<cn.eshore.common.entity.TreeModel < T>>
     * @MethosName convertListToTreevo
     */
     ...
     * @param t
     * @param tList
     * @return pri.xiaowd.layui.pojo.Treevo<T>
     * @MethosName getTreevoByT
     */
     ...
     * @param treeModelList
     * @param kClass      ID的类型
     * @return java.jnpf.util.Set<K>
     * @MethosName convertTreevoToIdSet
     */
